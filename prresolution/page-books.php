	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div class="container-fluid py-4 py-lg-5">
			<div class="row d-flex align-items-center pb-lg-5">
				...
				<div class="col-md-7 offset-lg-1 col-lg-6 mt-3 mt-lg-0">
					<h2 class="h1"><a href="/books/prs-digital-resolution" class="text-dark">Public Relations&rsquo; Digital Resolution</a></h2>
		...
		<div class="container-fluid py-4 py-lg-5">
			<div class="row d-flex align-items-center pb-lg-5">
				...
				<div class="col-md-7 offset-lg-1 col-lg-6 mt-3 mt-lg-0">
					<h2 class="h1"><a href="/books/consumer-insight-in-the-age-of-google" class="text-dark">Consumer Insight in the Age of Google</a></h2>
		...
		<div class="container-fluid py-4 py-lg-5">
			<div class="row d-flex align-items-center pb-lg-5">
				...
				<div class="col-md-7 offset-lg-1 col-lg-6 mt-3 mt-lg-0">
					<h2 class="h1"><a href="/books/pretrospective" class="text-dark">PRetrospective</a></h2>
