  ...
  <div class="row py-lg-5">
    <div class="col text-center">
      ...
      <div class="bg-shapes-i-dots">
        ...
        <p class="h3 font-weight-normal">With host <a href="https://twitter.com/stellabayles" class="text-primary">Stella Bayles</a></p>
      </div>
...
<div class="container-fluid py-4 py-lg-5 mb-3 mb-lg-5">
  <?php if ( intval( $paged ) == 0 ) : ?>
    <h3>Recent episodes &mdash;</h3>
  <?php else : ?>
    <h3>Page <?php echo $paged; ?></h3>
  <?php endif; ?>
  ...
  <div class="row mx-lg-n4 mx-xl-n5">
    <div class="col text-right">
      <?php if ( get_previous_posts_link() ) : ?>
        <a href="<?php echo get_previous_posts_page_link(); ?>" class="btn btn-lg btn-outline-dark">Newer episodes</a>
      <?php endif; ?>
    </div>
    <div class="col text-left">
      <?php if ( get_next_posts_link() ) : ?>
        <a href="<?php echo get_next_posts_page_link(); ?>" class="btn btn-lg btn-outline-dark">Older episodes</a>
      <?php endif; ?>
    </div>
  </div>
</div>
